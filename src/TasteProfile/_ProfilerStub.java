...
public class _ProfilerStub extends org.omg.CORBA.portable.ObjectImpl implements TasteProfile.Profiler
{
  ...
  public TasteProfile.UserProfile getUserProfile (String userId)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public TasteProfile.UserProfileSequence getTopTenUsers ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getTopTenUsers", true);
                $in = _invoke ($out);
                TasteProfile.UserProfileSequence $result = TasteProfile.UserProfileSequenceHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
